...
import mainfiles.CloseListener;
import mainfiles.ExitAction;
...
public class MainWindow extends JFrame implements ActionListener, KeyListener {
	...
	protected JButton mCButton1 = new JButton("7");
	protected JButton mCButton2 = new JButton("8");
	protected JButton mCButton3 = new JButton("9");
	protected JButton mCButton4 = new JButton("/");
	protected JButton mCButton5 = new JButton("4");
	protected JButton mCButton6 = new JButton("5");
	protected JButton mCButton7 = new JButton("6");
	protected JButton mCButton8 = new JButton("*");
	protected JButton mCButton9 = new JButton("1");
	protected JButton mCButton10 = new JButton("2");
	protected JButton mCButton11 = new JButton("3");
	protected JButton mCButton12 = new JButton("-");
	protected JButton mCButton13 = new JButton("=");
	protected JButton mCButton14 = new JButton("+");
	protected JButton mCButton15 = new JButton("0");
	...
	//Control method override for clickable events via keylisteners
	...
	{  if(kE.isControlDown() == false)
	   {
		if(kE.getKeyCode() == KeyEvent.VK_0){mCButton15.doClick();}
		if(kE.getKeyCode() == KeyEvent.VK_1){mCButton9.doClick();}
		if(kE.getKeyCode() == KeyEvent.VK_2){mCButton10.doClick();}
		if(kE.getKeyCode() == KeyEvent.VK_3){mCButton11.doClick();}
		if(kE.getKeyCode() == KeyEvent.VK_4){mCButton5.doClick();}
		if(kE.getKeyCode() == KeyEvent.VK_5){mCButton6.doClick();}
		if(kE.getKeyCode() == KeyEvent.VK_6){mCButton7.doClick();}
		if(kE.getKeyCode() == KeyEvent.VK_7){mCButton1.doClick();}
		if(kE.getKeyCode() == KeyEvent.VK_8){mCButton2.doClick();}
		if(kE.getKeyCode() == KeyEvent.VK_9){mCButton3.doClick();}
		if(kE.getKeyCode() == KeyEvent.VK_C){mCButton16.doClick();}
		if(kE.getKeyCode() == KeyEvent.VK_E){mCButton19.doClick();}
		if(kE.getKeyCode() == KeyEvent.VK_V){mCButton20.doClick();}
		if(kE.getKeyCode() == KeyEvent.VK_D){mCButton4.doClick();}
		if(kE.getKeyCode() == KeyEvent.VK_M){mCButton8.doClick();}
		if(kE.getKeyCode() == KeyEvent.VK_S){mCButton12.doClick();}
		if(kE.getKeyCode() == KeyEvent.VK_A){mCButton14.doClick();}
		if(kE.getKeyCode() == KeyEvent.VK_K){mCButton17.doClick();}
		if(kE.getKeyCode() == KeyEvent.VK_R){mCButton18.doClick();}
		if(kE.getKeyCode() == KeyEvent.VK_ENTER){mCButton13.doClick();}
	   }
	}
	...
	public void setUpContentPane(Container mCPane){
		if(RIGHT_TO_LEFT){
			mCPane.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
		}		
	...
	public void myCalcGui(){
		...
		mCFrame.setPreferredSize(new Dimension(250, 250));
